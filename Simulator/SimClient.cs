...
#pragma warning disable // Disable all warnings
    ...
    public partial class SimClient
    {
        ...
        public async System.Threading.Tasks.Task<Response> LoginAsync(string email, string password)
        {
            return await LoginAsync(email, password, System.Threading.CancellationToken.None);
        }
    ...
    public partial class InvoiceItem
    {
        ...
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public InvoiceItemType Type { get; set; } = Simulator.InvoiceItemType.DEBIT;
